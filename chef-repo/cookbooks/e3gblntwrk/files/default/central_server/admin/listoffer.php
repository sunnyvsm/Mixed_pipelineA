                                    ...
                                    <table class="table table-bordered">
										...
										?>
                                            <tr>
                                                ...
                                                <td><?php echo $row['rlink']; ?></td>
                                                <td><?php echo $row['olink']; ?></td>
                                              
                                                <td><?php echo $row['ulink']; ?></td>
                                                <td><?php echo $row['adddate']; ?></td>
                                                <td><a href="listoffer.php?deleteoffer=<?php echo $row['id']; ?>" style="color:#900;">DELETE</a></td>
                                            </tr>
                                         <?php
											}
